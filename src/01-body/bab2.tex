...
\section{Masalah Pemeringkatan Teks}
    ...
    \subsubsection{\f{Recall} dan Presisi}
        ...
        \begin{figure}
            ...
            \captionsource{Ilustrasi \f{reciprocal rank} (RR). Nilai RR pada sistem A, B, dan C berturut-turut adalah 1, 0.33, dan 0.5 karena posisi dari teks yang relevan pertama adalah 1, 3, dan 2.}{\citep{irlecture}.}
    ...
    \subsubsection{\f{Normalized Discounted Cumulative Gain} (nDCG)}
        ...
        \begin{figure}
            ...
            \captionsource{Ilustrasi perhitungan nDCG. Nilai nDCG dari sistem A, B, adalah rasio antara DCG dari sistem tersebut dengan DCG dari sistem ideal.}{\citep{irlecture}, telah diolah kembali.}
            \label{fig:ndcg}
        \end{figure}
...
\begin{figure}
    ...
    \captionsource{100 iterasi pertama dari pembaruan parameter $\bm{\theta} = \{w_1, w_2\}$ dengan \f{learning rate} yang terlalu kecil dan terlalu besar.}{\citep{geiger2022deeplearning}.}
...
\begin{figure}
    ...
    \captionsource{100 iterasi pertama dari pembaruan parameter $\bm{\theta} = \{w_1, w_2\}$ dengan \f{learning rate} yang baik.}{\citep{geiger2022deeplearning}.}
...
\begin{figure}
    ...
    \captionsource{Ilustrasi dari pembaruan parameter $\bm{\theta}$ dengan \f{stochastic gradient descent} dengan momentum.}{\citep{geiger2022deeplearning}.}
...
\begin{figure}
    ...
    \captionsource{Ilustrasi dari pembaruan parameter $\bm{\theta}$ dengan \f{stochastic gradient descent} dengan \f{adaptive learning rate}.}{\citep{geiger2022deeplearning}.}
    \label{fig:rmsprop}
\end{figure}
...
\begin{figure}
    ...
    \captionsource{Ilustrasi dari pembaruan parameter $\bm{\theta}$ dengan Adam.}{\citep{geiger2022deeplearning}.}
    \label{fig:adam}
\end{figure}
\begin{align}
    \label{eq:adam}
