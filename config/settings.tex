...
\def\judul{Pemeringkatan Teks Bahasa Indonesia Dengan BERT}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
% \def\judulInggris{Fine-tuning BERT Model for Improved Text Representation in Text Ranking Problems.}
\def\judulInggris{Text Ranking in Indonesian Using BERT}
...
\Var{\babTiga}{Bidirectional Encoder Representation from Transformer (BERT) Untuk Pemeringkatan Teks}
