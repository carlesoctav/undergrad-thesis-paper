...
\def\judul{Aplikasi \f{Bidirectional Encoder Representations from Transformers} untuk Pemeringkatan Teks Bahasa Indonesia}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
% \def\judulInggris{Fine-tuning BERT Model for Improved Text Representation in Text Ranking Problems.}
\def\judulInggris{Bidirectional Encoder Representations from Transformers Application for Text Ranking in Indonesian}
...
%
% Tuliskan penguji
\def\pengujiSatu{Dr.rer.nat. Hendri Murfi, S.Si., M.Kom.}
\def\pengujiDua{Dra. Nora Hariadi, M.Si.}
...
% penguji/sekretariat
\def\tanggalSiapSidang{27 Desember 2023}
%
% Tuliskan tanggal keputusan sidang dikeluarkan dan penulis dinyatakan
% lulus/tidak lulus
\def\tanggalLulus{3 Januari 2024}
...
\Var{\babTiga}{\f{Bidirectional Encoder Representations from Transformers} Untuk Pemeringkatan Teks}
\Var{\babEmpat}{Hasil Simulasi dan Pembahasan}
